...
import 'package:smolstock/Screens/Utilities/Riverpod/riverpod_classes.dart';
...
final chatbotProvider =
    StateNotifierProvider<ChatbotNotifier, List<ChatbotMessage>>((ref) {
  return ChatbotNotifier();
});

final chatbotTextProvider =
    StateNotifierProvider<ChatbotTextNotifier, TextEditingController>((ref) {
  return ChatbotTextNotifier();
});
